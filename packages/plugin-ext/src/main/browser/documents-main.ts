...
import { UriComponents } from "../../plugin/types-impl";
...
export class DocumentsMainImpl implements DocumentsMain {
    ...
    private onModelAdded(model: MonacoEditorModel): void {
        ...
        this.modelToDispose.set(modelUrl.toString(), model.textEditorModel.onDidChangeContent(e => {
            this.proxy.$acceptModelChanged(modelUrl, e, model.dirty);
        }));
    ...
    $tryCreateDocument(options?: { language?: string | undefined; content?: string | undefined; } | undefined): PromiseLike<UriComponents> {
